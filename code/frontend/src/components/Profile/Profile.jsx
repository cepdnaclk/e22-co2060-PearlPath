...
const Profile = () => {
    ...
    const handleMarkAsRead = async (id) => {
        try {
            const res = await authFetch(`http://localhost:3001/api/notifications/${id}/read`, {
                method: 'PUT'
            });
            if (res.ok) {
    ...
    const handleMarkAllAsRead = async () => {
        try {
            const res = await authFetch('http://localhost:3001/api/notifications/read-all', {
                method: 'PUT'
            });
            if (res.ok) {
    ...
    const handleDeleteNotification = async (id) => {
        try {
            const res = await authFetch(`http://localhost:3001/api/notifications/${id}`, {
                method: 'DELETE'
            });
            if (res.ok) {
